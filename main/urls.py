...
urlpatterns = [
    ...
    url(r'^volunteer/letter-verification/accept/(?P<letter_id>\d+)/', views.accept_letter,
        name='decline_letter'),
    url(r'^volunteer/letter-verification/decline/(?P<letter_id>\d+)/', views.decline_letter,
        name='accept_letter'),
