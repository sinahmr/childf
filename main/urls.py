...
urlpatterns = [
    ...
    url(r'^volunteer/letter-verification/accept/(?P<letter_id>\d+)/', views.volunteer_letter_verification,
        name='decline_letter'),
    url(r'^volunteer/letter-verification/decline/(?P<letter_id>\d+)/', views.volunteer_letter_verification,
        name='accept_letter'),
